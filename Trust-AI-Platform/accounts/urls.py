...
urlpatterns = [
    ...
    path('admin/email/recipient-count/', admin_views.admin_bulk_email_recipient_count, name='admin_bulk_email_recipient_count'),
    path('admin/email/send/', admin_views.admin_send_bulk_email, name='admin_send_bulk_email'),
